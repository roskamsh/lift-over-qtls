...
}' data/intermediary/eQTLGen_matched_snps_hg38.vcf > data/intermediary/eQTLs_hg38_with_alleles.txt

# Lift over original file
python add_coords.py data/intermediary/eQTLs_hg38_with_alleles.txt \
...
}' data/intermediary//baalnf_matched_snps_hg38.vcf > data/intermediary/baalnf_snps_hg38_with_alleles.txt

# Lift over original file
python add_coords.py data/intermediary/baalnf_snps_hg38_with_alleles.txt \
                     data/dbSNP/GCF_000001405.40_GRCh38.p14_assembly_report.txt \
...
}' data/intermediary/transactor_matched_snps_hg19.vcf > data/intermediary/transactors_hg19_with_alleles.txt

# Lift over original files & add allele information
python add_coords.py data/intermediary/transactors_hg19_with_alleles.txt \
